...
const ManageBiography = () => {
    ...
    return (
        <div className="space-y-8 p-6">
            ...
            {/* Управление текстами */}
            <div className="bg-white p-6 rounded shadow-md">
                <h3 className="text-xl font-semibold mb-4">{t("admin.texts")}</h3>
                <div className="space-y-4">
                    {texts.map(text => (
                        <div key={text.id} className="flex flex-col space-y-2 border-b pb-4">
                            <div className="flex space-x-2">
                                <input
                                    type="text"
                                    value={text.key}
                                ...
                                <input
                                    type="text"
                                    value={text.value_en}
                                    onChange={(e) => handleUpdateText(text.id, { ...text, value_en: e.target.value })}
                                    className="border p-2 rounded flex-1"
                                ...
                                <input
                                    type="text"
                                    value={text.value_ru}
                                    onChange={(e) => handleUpdateText(text.id, { ...text, value_ru: e.target.value })}
                                    className="border p-2 rounded flex-1"
                    ...
                    <div className="flex flex-col space-y-2">
                        <h4 className="text-lg font-medium">Добавить текст</h4>
                        <div className="flex space-x-2">
                            <input
                                type="text"
                                value={newText.key}
                            ...
                            <input
                                type="text"
                                value={newText.value_en}
                                onChange={(e) => setNewText({ ...newText, value_en: e.target.value })}
                                className="border p-2 rounded flex-1"
                                placeholder="Текст (EN)"
                            />
                            <input
                                type="text"
                                value={newText.value_ru}
                                onChange={(e) => setNewText({ ...newText, value_ru: e.target.value })}
                                className="border p-2 rounded flex-1"
                                placeholder="Текст (RU)"
                            />
                            <button
